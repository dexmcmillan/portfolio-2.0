<template>
    <div class="col-span-3 mb-7 px-15">
      ...
      <p class="text-xl">Interested in hiring me? Click the tags to toggle which skills you're interested in seeing on this page. Only those tags in dark blue will be shown.</p>
    </div>
  </template>
